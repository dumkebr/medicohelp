...
export default function CallOverlay({ 
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/40">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-[360px] p-5 text-center">
        <div className="flex flex-col items-center gap-4">
          ...
          />
          <div>
            <div className="text-sm text-gray-500 dark:text-gray-400">MédicoHelp</div>
            <div className="text-xl font-semibold dark:text-white">Dra. Clarice</div>
          </div>
          ...
          {onClose && (
            <button
              onClick={onClose}
              className="mt-2 px-4 py-2 rounded-xl bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white"
