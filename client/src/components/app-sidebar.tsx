      ...
      <SidebarHeader className="px-3 py-4 border-b bg-[#052828]">
        <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
          ...
          <div className="flex items-baseline gap-0.5">
            <span className="text-2xl font-bold tracking-tight text-white">Médico</span>
            <span className="text-2xl font-bold tracking-tight text-[#1affb8]">Help</span>
          </div>
        </Link>
      </SidebarHeader>
      ...
      <SidebarContent className="pt-0">
        ...
        <SidebarGroup>
          <SidebarGroupContent>
            ...
            >
              <img src={medprimeHeartIcon} alt="" className="h-12 w-12" aria-hidden="true" />
              <div className="flex-1 min-w-0">
                <div className="text-lg font-bold truncate">MedPrime</div>
                <div className="text-sm opacity-75 truncate">Ferramentas Avançadas</div>
              </div>
